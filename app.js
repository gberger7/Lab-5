...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var totalProd = multiply(prod1[0],c);

var third =  a + ' and ' + b + ' and ' + c + ' sum to ' + totalSum[0] + '.';
var fourth = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + totalProd[0] + '.';

return [totalSum[0], totalProd[0], third, fourth];
}
...
function sumArray(testArray){ //eslint-disable-line
  ...
  var message = a + ',' + b + ',' + c + ' was passed in as an array of numbers, and ' + totalSum[0] + ' is their sum. ';
  return [totalSum[0], message];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var message = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + totalProd[0] + '.';
